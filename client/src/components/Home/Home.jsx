...
import { videogameGET } from "../../redux/actions/index";
import Nav from "../Nav/Nav";
import CardVideogame from "../CardVg/CardVg";
import Pagination from "../Pagination/Pagination";
import Filters from "../Filters/Filters";
import OrderBy from "../OrderBy/OrderBy";
import { FilterGenres, DB_API } from "../../redux/actions/index";
import { ORDER_ALFABETICO, ORDER_RATINGS } from "../../redux/actions/index";
...
export default function Home() {
    ...
    function handlerByName(e) {
        dispatch(ORDER_ALFABETICO(e.target.value))
        setCurrentPage(1);
        setRatingchange("");
    ...
    function handlerByRating(e) { 
        dispatch(ORDER_RATINGS(e.target.value));
        setCurrentPage(1);   
        setNamechange("");                   
